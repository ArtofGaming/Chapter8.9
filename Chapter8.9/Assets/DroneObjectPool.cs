...
public class DroneObjectPool : MonoBehaviour
{
    ...
    public int attackDefaultCapacity = 10;
    ...
    public IObjectPool<Drone> Pool
    {
        get
        {
            if(_pool == null)
            {
                _pool = new ObjectPool<Drone>(CreatedPooledItem, OnTakeFromPool, OnReturnedToPool, OnDestroyPoolObject, true, attackDefaultCapacity, maxPoolSize);
